...
assert.match(studioCss, /grid-template-columns: minmax\(var\(--spacing-16\), 280px\) minmax\(520px, 1fr\) minmax\(var\(--spacing-16\), 320px\)/)
...
assert.match(gameCss, /grid-template-columns: minmax\(var\(--spacing-16\), 220px\) minmax\(720px, 1fr\) minmax\(var\(--spacing-16\), 160px\)/)
assert.match(gameCss, /min-width: 720px/)

...
export const SKETCH = {
  /** 일반 테두리(버튼·카드·바). */
  frame: { roughness: 1.5, bowing: 1.6, strokeWidth: 2.4 },
  /** 작은 부속품(아이콘 칩·탭) — 과하지 않게. */
  chip: { roughness: 1.2, bowing: 1.3, strokeWidth: 2 },
  /** 팝업·안내판 테두리 — 조금 더 크게 꼬불. */
  panel: { roughness: 1.8, bowing: 1.8, strokeWidth: 2.6 },
} as const;
